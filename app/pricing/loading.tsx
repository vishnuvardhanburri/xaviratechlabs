      ...
      <section className="relative py-24 px-8 lg:px-16 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-gray-800/30 border border-cyan-500/20 rounded-lg p-8 h-96"
            >
              <div className="h-6 bg-gray-700/50 rounded mb-6" />
              <div className="h-12 bg-cyan-500/20 rounded-lg mb-4" />
